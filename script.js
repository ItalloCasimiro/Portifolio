...
const translations = {
    pt: {
        ...
        TextAbout: "Sobre Mim, Itallo Casimiro",
        Text: "Olá! Sou estudante de design de jogos e programação, estou me preparando para ter minha primeira experiência de trabalho com desenvolvimento de jogos",

        skillsTitle: "Habilidades",
        skill1Title: "Unity e Godot",
        skill1Text: "Conhecimentos sobre as Engines Unity e Godot",

        skill2Title: "Programação",
        skill2Text: "Conhecimento em C# e GDScript",

        skill3Title: "Game Art",
        skill3Text: "Habilidades com artes 2D para jogos",

        skill4Title: "Design de UI/UX",
        skill4Text: "Habilidades com design de UI/UX 2D para jogos",

        skill5Title: "Programação",
        skill5Text: "Conhecimento em programação com as linguagens C# e GDScript",

        skill6Title: "Inglês",
        skill6Text: "Conhecimento em inglês em nível intermediário / avançado",

        skill7Title: "Versionamento de código",
        skill7Text: "Conhecimento em versionamento de código com Git",

        skill8Title: "Desenvolvimento web",
        skill8Text: "Conhecimento em HTML e CSS para criação de páginas web",

        skill9Title: "Tradução para jogos",
        skill9Text: "Experiência em tradução e localização para jogos",

        skill10Title: "Criação de diálogos e puzzles",
        skill10Text: "Idealização e aplicação de diálogos e puzzles para jogos",

        myTechnologiesTitle: "Minhas Tecnologias",
        ...
        acessProjectDetails: "Acessar os detalhes do projeto",
        acessAllProjectsAndParticipations: "Acessar todos os projetos e participações",
        acessItchioGamePage: "Acessar a página do jogo na Itch.io",

        gameDesignExperienceCourseTitle: "Certificado do curso Game Design Experience",
        gameDesignExperienceCourseDescription: "Este curso me ensinou muito sobre o game design e fundamentos essenciais que não sabia.",

        learnDesignFor2DGamesCourseTitle: "Certificado do curso Aprenda Design de Jogos 2D com Arte Vetorial e Inkscape",
        learnDesignFor2DGamesCourseDescription: "Este curso me ensinou a criar artes vetoriais para jogos 2D com o software Inkscape.",
        ...
        discordServer: "Servidor no Discord",
    },

    en: {
        docTitle: "My Portfolio",
        ...
        TextAbout: "About Me, Itallo Casimiro",
        Text: "Hello! I am a game design and programming student, preparing my self for a first professional experience in game development",

        skillsTitle: "Skills",
        skill1Title: "Unity and Godot",
        skill1Text: "Knowledge of Unity and Godot engines",

        skill2Title: "GDD Documentation",
        skill2Text: "Experience with GDD documents creation",

        skill3Title: "Game Art",
        skill3Text: "Experience with 2D art for games",

        skill4Title: "UI/UX Design",
        skill4Text: "Experience with UI/UX design for games",

        skill5Title: "Programming",
        skill5Text: "Experience with C# and GDScript",

        skill6Title: "English",
        skill6Text: "Knowledge of English at intermediate / advanced level",

        skill7Title: "Version Control",
        skill7Text: "Experience with Git for version control",

        skill8Title: "Web Development",
        skill8Text: "Knowledge of HTML and CSS for web development",

        skill9Title: "Game Localization",
        skill9Text: "Experience with game translation and localization",

        skill10Title: "Dialogue and Puzzle Design",
        skill10Text: "Experience with dialogue and puzzle design for games",
        ...
        acessProjectDetails: "Acess the project details",
        acessAllProjectsAndParticipations: "Acess all projects and participations",
        acessItchioGamePage: "Acess the Itch.io game page",

        gameDesignExperienceCourseTitle: "Game Design Experience Course Certificate",
        gameDesignExperienceCourseDescription: "This course taught me a lot about game design and essential fundamentals that I didn't know.",

        learnDesignFor2DGamesCourseTitle: "Learn Design for 2D Games and Vetorial Art with Inkscape Course Certificate",
        learnDesignFor2DGamesCourseDescription: "This course taught me how to create vetorial art for 2D games using Inkscape.",
...
function setLanguage(lang) {
    ...
    const activeButton = document.querySelector(
        `.LanguageSwitcher button[onclick="setLanguage('${lang}')"]`
    );
